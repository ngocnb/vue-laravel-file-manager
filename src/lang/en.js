...
const en = {
  ...
  modal: {
    ...
    preview: {
      ...
      metadata: {
        title: "Metadata",
        altLabel: "Alt",
        altPlaceholder: "Alt placeholder",
    ...
    upload: {
      ...
      title: "Upload files",
      dropzone: {
        text: "Drop files here or click to select files"
      }
    },
    editor: {
      title: "Editor"
  ...
  response: {
    ...
    // metadata
    metadataUpdated: "Metadata is updated successfully!",
    metadataUpdateFailed: "Metadata is failed to update!"
  }
};
